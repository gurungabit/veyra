...
import {
  ...
  isClassItem,
  itemName,
  type FarmJoeRuntimeOptions,
  type PetChoice
} from "./FarmJoeRuntime.js";

export const meta = {
  name: "CoreFarmerJoe",
  description: "Veyra FarmerJoe progression, class setup, outfit, pet, and endgame flow.",
  tags: ["farmjoe", "progression", "core"],
  version: "0.1.0"
};
...
export class CoreFarmerJoe {
  ...
  private async handleLevel50(): Promise<void> {
    ...
    if (
      ...
      !(await this.runtime.anyRank10(["Dragonslayer General"]))
    )
