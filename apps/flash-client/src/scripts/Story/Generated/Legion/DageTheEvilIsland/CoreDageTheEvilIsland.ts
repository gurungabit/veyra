...
export const meta = {
  "name": "Legion / Dage The Evil Island / Core Dage The Evil Island",
  "description": "Runs the Legion / Dage The Evil Island / Core Dage The Evil Island story route.",
  "tags": [
    "story",
    "legion",
    "dage",
...
export const definition = defineGeneratedStory(
  {
    id: "story.legion.dage-the-evil-island.core-dage-the-evil-island",
    category: "Story",
    map: "DarkFortress",
    meta
  },
