...
import veyra.api.Combat;
import veyra.api.Monster;
import veyra.api.Player;
import veyra.api.Server;
import veyra.api.Shop;
import veyra.api.Skills;
import veyra.api.World;
import veyra.module.Modules;
import veyra.remote.RemoteRegistry;
...
public class Externalizer {
    ...
    public function init(root:Main):void {
        ...
        this.addCallback("callGameFunctionSafe", Main.callGameFunctionSafe);
        this.addCallback("callGameFunction0Safe", Main.callGameFunction0Safe);
